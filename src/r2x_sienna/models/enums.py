...
class TransformerControlObjective(StrEnum):
    ...
    UNDEFINED = "UNDEFINED"  # -99
    VOLTAGE_DISABLED = "VOLTAGE_DISABLED"  # -1
    REACTIVE_POWER_FLOW_DISABLED = "REACTIVE_POWER_FLOW_DISABLED"  # -2
    ACTIVE_POWER_FLOW_DISABLED = "ACTIVE_POWER_FLOW_DISABLED"  # -3
    CONTROL_OF_DC_LINE_DISABLED = "CONTROL_OF_DC_LINE_DISABLED"  # -4
    ASYMMETRIC_ACTIVE_POWER_FLOW_DISABLED = "ASYMMETRIC_ACTIVE_POWER_FLOW_DISABLED"  # -5
    FIXED = "FIXED"  # 0
    VOLTAGE = "VOLTAGE"  # 1
    REACTIVE_POWER_FLOW = "REACTIVE_POWER_FLOW"  # 2
    ACTIVE_POWER_FLOW = "ACTIVE_POWER_FLOW"  # 3
    CONTROL_OF_DC_LINE = "CONTROL_OF_DC_LINE"  # 4
    ASYMMETRIC_ACTIVE_POWER_FLOW = "ASYMMETRIC_ACTIVE_POWER_FLOW"  # 5
